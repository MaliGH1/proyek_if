...
<section class="" id="contact-section">
    <div class="flex items-top justify-center min-h-screen sm:items-center sm:pt-0 py-0 my-0" data-aos="zoom-out">
        <div class="max-w-1xl mx-auto sm:px-4 lg:px-6">
            ...
            <div class="max-w-1xl mx-auto sm:px-4 lg:px-l" data-aos="zoom-out">
                <div class="flex items-top justify-center min-h-screen sm:items-center sm:pt-0 py-0 my-0">
                    <div class="max-w-1xl mx-auto sm:px-4 lg:px-6" data-aos="zoom-out">
                        <div class="overflow-hidden">
                            <div class="grid grid-cols-1 md:grid-cols-1">
                                <div class="p-6 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">


                                    <div class="text-center"> <!-- Centering div added here -->
                                        <h1 class="text-4xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight">
                                            Hubungi Kami
                                        </h1>
                                    </div>
                                    <p class="text-center  text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2 ">
                                        Untuk Pertanyaan lebih lanjut
                                    </p>


                                    <div class="flex items-center mt-10 text-gray-600 dark:text-gray-400">
                                    ...
                                    <!-- PETA -->
                                    <div class="flex justify-center max-w-10xl mx-auto sm:px-4 lg:px-l" data-aos="zoom-out">
                                        <a href="https://www.google.com/maps/@-6.913957,106.9243981,3a,75y,115.66h,90.31t/data=!3m6!1e1!3m4!1sZys4ZloIa56ly31-KLWGXQ!2e0!7i16384!8i8192?entry=ttu" target="_blank">
                                            <img src="image/PetaDJVR.png" alt="Peta DJVR" width="1500" />
                                        </a>
                                    </div>
