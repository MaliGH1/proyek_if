    ...
    <div class="layout">
        ...
        <form action="/sewa" method="POST">
            ...
            <!-- <div class="relative inline-block text-left">
                ...
                <!-- Bagian HTML -->
            <div class="absolute right-0 mt-2 space-y-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 hidden" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-button" tabindex="-1" id="dropdown-menu">
                <!-- List mobil di sini -->
                <a href="#" class="flex items-center p-1 space-x-1">
                    <img src="https://res.cloudinary.com/mufautoshow/image/upload/f_auto,f_auto/w_1200/v1621137839/moas/news/1621137832_toyota-alphard-transformers-mpv-mewah-terbaik-di-indonesia.png" alt="Mobil 1" class="w-600 h-600">
                    <span>Toyota Alphard</span>
                </a>
                <a href="#" class="flex items-center p-1 space-x-1" data-harga="600000">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/2021_Toyota_Yaris_TRD_Sportivo_1.5_%28Indonesia%29_front_view_01.jpg/1280px-2021_Toyota_Yaris_TRD_Sportivo_1.5_%28Indonesia%29_front_view_01.jpg" alt="Mobil 2" class="w-600 h-600">
